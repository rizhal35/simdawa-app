...
$pdf->Cell(18, 1, "Nama Program Studi", 1, 1, "C", true); // Change 0 to 1 to move to the next line & Adjusted width to 17 to fit the page
$pdf->SetFont("Arial", "", 11);
$no = 1;
foreach ($prodi as $a) {
    $pdf->Cell(1, 1, $no++, 1, 0, "C");
    $pdf->Cell(18, 1, $a->nama_prodi, 1, 1, "C"); // Change 0 to 1 to move to the next line & Adjusted width to 17 to fit the page
}
